...
namespace OpenTK_winforms_z02 {
    public partial class Form1 : Form {
        ...
        private float[] valuesSpecularTemplate0 = new float[] { 1.0f, 0.1f, 0.1f, 1.0f };
        ...
        private void LoadTextures() {
            ...
            LoadTexture(textures[0], "Customtex.jpg");
            LoadTexture(textures[1], "textura.jpg");
        }
        ...
        private void resetTexCubes() {
         ...
         private void DeseneazaPir_Tex1() {
            if (brick == true)
            {
